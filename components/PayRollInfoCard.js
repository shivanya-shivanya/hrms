...
export default function PayRollInfoCard() {
    ...
    const renderItem = (item) => {
        return (
            <View style={{
                ...
                <View style={[styles.payContainer]}>
                    ...
                    <View style={{ marginLeft: 'auto', marginRight: 15 }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('BreakScreen')}>
                            <Text style={styles.addBreak}>View Break</Text>
                        </TouchableOpacity>
                ...
                <View style={[styles.payContainer, { flexDirection: 'column', rowGap: 10, }]}>
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: "flex-end", paddingBottom: 10, borderBottomWidth: Platform.OS === 'android' ? 0.5 : 0.2, borderBottomColor: colors.txtColor }}>
                        <View style={{ paddingHorizontal: 5 }}>
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: "flex-end" }}>
                        ...
                        <View style={{ marginLeft: 'auto', marginRight: 15 }}>
                            <Text style={styles.emailLabel}>$175.00</Text>
                        </View>
                    </View>
                </View>
            </View>
...
const styles = StyleSheet.create({
    ...
    workingHrsConatiner: {
        ...
        borderBottomWidth: 0.4, borderBottomColor: colors.txtColor, paddingVertical: 10
    },
