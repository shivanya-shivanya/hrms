        ...
        return (
            <View style={{
                ...
                <View style={[styles.attContainer, { flexDirection: 'column' }]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingBottom: 15, borderBottomWidth: Platform.OS === 'ios' ? 0.18 : 0.5, borderBlockColor: colors.txtColor }}>
                        <Text style={styles.attend}>Applied on</Text>
                        <Text style={styles.date}>Applied For</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%',marginTop:moderateScale(10)}}>
                        <Text style={styles.date}>Jan 5 , 2023</Text>
                        <Text style={styles.date}>Jan 5 , 2023</Text>
                    </View>
                </View>
                ...
                <View style={styles.attSubContent}>
                    ...
                    <View style={[styles.workingHrsConatiner, { borderBottomWidth: 0 }]}>
                        <View style={{ flexDirection: 'row', width: '20%' }}>
                            <Text style={styles.time}>Casual Leave</Text>
                        </View>
                        <View style={{ flexDirection: 'row', width: '20%' }}>
                            <Text style={[styles.time,{textAlign:'center'}]}>HR Approved</Text>
                        </View>
                        <View style={{ flexDirection: 'row', width: '20%' }}>
...
const styles = StyleSheet.create({
    ...
    workingHrsConatiner: {
        ...
        paddingBottom: 10, borderBottomWidth: 0.4, borderBottomColor: colors.txtColor, paddingTop: 15
    },
