...
export default function EditBankaccount() {
    ...
    return (
        <View style={styles.container}>
            ...
            <NavBarWithBackIcon title="Edit Bank Detail" />
            <View style={styles.imgContainer}>
                ...
                <Modal
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            ...
                            <Text style={styles.modalText}>Account Updated</Text>
                            <View style={styles.successContainer}>
                                <Image source={require('../../../components/assets/images/success.png')} style={styles.successImg} />
                            </View>
                            <View style={{ justifyContent: 'center', alignSelf: 'center', width: Platform.OS === 'android' ? '70%' : '75%' }}>
                                <Text style={styles.successtext}>Your bank account has been updated successfully</Text>
                            </View>
                            <GreenButton
                                title="Looks Good"
                ...
                <View style={{ width: '100%', marginBottom: Platform.OS === 'android' ? moderateScale(20) : moderateScale(40), marginTop: 10 }}>
                    <GreenButton title="Update" onPress={() => setModalVisible(!modalVisible)} />
                </View>
...
const styles = StyleSheet.create({
    ...
    checkboxContainer: {
        flexDirection: 'row', marginLeft: moderateScale(25), marginTop: moderateScale(15)
    },
