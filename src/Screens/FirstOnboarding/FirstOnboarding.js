import { View, Text, StyleSheet, Image, Dimensions, TouchableOpacity, StatusBar, Platform } from 'react-native'
import React from 'react'
import { colors } from '../../../components/colors';
import { useNavigation } from '@react-navigation/native';
import { FocusAwareStatusBar } from '../../../components/FocusAwareStatusBar';
import { TopSpace } from '../Utils/DImensions';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.subContainer}>
                ...
                <View style={styles.imgContainer}>
                    <Image source={require('../../../components/assets/images/firstSplash.png')} style={styles.splashLogo} />
                </View>
            </View>
            <View style={styles.secondContainer}>
                <Text style={styles.healthText}>Keep healthy</Text>
                <Text style={styles.healthText2}>work-life balance</Text>
                ...
                <View style={styles.sliderContainer}>
                    <Image source={require('../../../components/assets/images/Slider.png')} style={styles.sliderImages} />
                    <TouchableOpacity style={styles.btnContainer} onPress={() => navigation.navigate("SecondOnboarding")}  >
                        <Image source={require('../../../components/assets/images/button.png')} style={styles.sliderBtn} />
                    </TouchableOpacity>
                </View>
            </View>
...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: colors.lightBlue, paddingTop: Platform.OS === 'ios' ?  10 : 10 },
